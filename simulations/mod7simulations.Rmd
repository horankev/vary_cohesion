...
# saveRDS(sim_data_rcar, here("simulations","sim_geo_data","sim_data_rcar_mod7.rds"))
...
saveRDS(m6_fit_to_3, here("simulations","sim_mods","m6_fit_to_3.rds"))

# m6_fit_to_3 <- readRDS(here("simulations","sim_mods","m6_fit_to_3.rds"))
...
```{r}
ml_m6_fit_to_3 <- bridge_sampler(m6_fit_to_3)
saveRDS(ml_m6_fit_to_3, here("simulations","sim_mods","ml_m6_fit_to_3.rds"))

# ml_m6_fit_to_3 <- readRDS(here("simulations","sim_mods","ml_m6_fit_to_3.rds"))
...
saveRDS(m6_fit_to_4, here("simulations","sim_mods","m6_fit_to_4.rds"))

# m6_fit_to_4 <- readRDS(here("simulations","sim_mods","m6_fit_to_4.rds"))
...
```{r}
ml_m6_fit_to_4 <- bridge_sampler(m6_fit_to_4)
saveRDS(ml_m6_fit_to_4, here("simulations","sim_mods","ml_m6_fit_to_4.rds"))

# ml_m6_fit_to_4 <- readRDS(here("simulations","sim_mods","ml_m6_fit_to_4.rds"))
...
saveRDS(m6_fit_to_6, here("simulations","sim_mods","m6_fit_to_6.rds"))

# m6_fit_to_6 <- readRDS(here("simulations","sim_mods","m6_fit_to_6.rds"))
...
dummy_fit@sim <- m6_fit_to_6@sim
dummy_fit@inits <- m6_fit_to_6@inits
dummy_fit@mode <- m6_fit_to_6@mode
...
ml_m6_fit_to_6 <- bridge_sampler(
  samples = dummy_fit,
  data = datalist,
  silent = TRUE
)
saveRDS(ml_m6_fit_to_6, here("simulations","sim_mods","ml_m6_fit_to_6.rds"))

# ml_m6_fit_to_6 <- readRDS(here("simulations","sim_mods","ml_m6_fit_to_6.rds"))
...
saveRDS(m6_fit_to_bym, here("simulations","sim_mods","m6_fit_to_bym.rds"))

# m6_fit_to_bym <- readRDS(here("simulations","sim_mods","m6_fit_to_bym.rds"))

```


```{r}
summary(m6_fit_to_bym)

```

```{r}
ml_m6_fit_to_bym <- bridge_sampler(m6_fit_to_bym)
saveRDS(ml_m6_fit_to_bym, here("simulations","sim_mods","ml_m6_fit_to_bym.rds"))

# ml_m6_fit_to_bym <- readRDS(here("simulations","sim_mods","ml_m6_fit_to_bym.rds"))
...
```{r}
ml_mod7simulations <- data.frame(
  model = c("3","4","6","BYM2"),
  logmarglik = c(ml_m6_fit_to_3$logml, ml_m6_fit_to_4$logml, ml_m6_fit_to_6$logml, ml_m6_fit_to_bym$logml)
) |> 
  arrange(desc(logmarglik))
ml_mod7simulations

saveRDS(ml_mod7simulations, here("simulations","sim_ml","ml_mod7simulations.rds"))
