...
saveRDS(m3_fit_to_3, here("simulations","sim_mods","m3_fit_to_3.rds"))

# m3_fit_to_3 <- readRDS(here("simulations","sim_mods","m3_fit_to_3.rds"))
...
saveRDS(ml_m3_fit_to_3, here("simulations","sim_mods","ml_m3_fit_to_3.rds"))

# ml_m3_fit_to_3 <- readRDS(here("simulations","sim_mods","ml_m3_fit_to_3.rds"))
...
saveRDS(m3_fit_to_4, here("simulations","sim_mods","m3_fit_to_4.rds"))

# m3_fit_to_4 <- readRDS(here("simulations","sim_mods","m3_fit_to_4.rds"))
...
saveRDS(ml_m3_fit_to_4, here("simulations","sim_mods","ml_m3_fit_to_4.rds"))

# ml_m3_fit_to_4 <- readRDS(here("simulations","sim_mods","ml_m3_fit_to_4.rds"))
...
saveRDS(m3_fit_to_6, here("simulations","sim_mods","m3_fit_to_6.rds"))

# m3_fit_to_6 <- readRDS(here("simulations","sim_mods","m3_fit_to_6.rds"))
...
saveRDS(ml_m3_fit_to_6, here("simulations","sim_mods","ml_m3_fit_to_6.rds"))

# ml_m3_fit_to_6 <- readRDS(here("simulations","sim_mods","ml_m3_fit_to_6.rds"))
...
saveRDS(m3_fit_to_bym, here("simulations","sim_mods","m3_fit_to_bym.rds"))

# m3_fit_to_bym <- readRDS(here("simulations","sim_mods","m3_fit_to_bym.rds"))
...
saveRDS(ml_m3_fit_to_bym, here("simulations","sim_mods","ml_m3_fit_to_bym.rds"))

# ml_m3_fit_to_bym <- readRDS(here("simulations","sim_mods","ml_m3_fit_to_bym.rds"))
...
ml_mod3simulations <- data.frame(
  model = c("3","4","6","BYM2"),
  logmarglik = c(ml_m3_fit_to_3$logml, ml_m3_fit_to_4$logml, ml_m3_fit_to_6$logml, ml_m3_fit_to_bym$logml)
) |> 
  arrange(desc(logmarglik))
ml_mod3simulations

saveRDS(ml_mod3simulations, here("simulations","sim_ml","ml_mod3simulations.rds"))
