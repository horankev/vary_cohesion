...
# 
# saveRDS(dfsmall, here("simulations","dfsmall.rds"))
...
transformed data {
  // Empty block, not centring anything
}
...
# saveRDS(sim_data_rcar, here("simulations","sim_geo_data","sim_data_rcar_mod3.rds"))
...
saveRDS(m3_fit_to_3, here("simulations","sim_mods","m3_fit_to_3_sample10.rds"))

# m3_fit_to_3 <- readRDS(here("simulations","sim_mods","m3_fit_to_3_sample10.rds"))
...
```{r}
ml_m3_fit_to_3 <- bridge_sampler(m3_fit_to_3)
saveRDS(ml_m3_fit_to_3, here("simulations","sim_mods","ml_m3_fit_to_3_sample10.rds"))

# ml_m3_fit_to_3 <- readRDS(here("simulations","sim_mods","ml_m3_fit_to_3_sample10.rds"))
...
#   save_pars = save_pars(all = TRUE)
# )
# saveRDS(m3_fit_to_4, here("simulations","sim_mods","m3_fit_to_4_sample10.rds"))

# m3_fit_to_4 <- readRDS(here("simulations","sim_mods","m3_fit_to_4_sample10.rds"))
...
```{r}
# ml_m3_fit_to_4 <- bridge_sampler(m3_fit_to_4)
# saveRDS(ml_m3_fit_to_4, here("simulations","sim_mods","ml_m3_fit_to_4_sample10.rds"))

# ml_m3_fit_to_4 <- readRDS(here("simulations","sim_mods","ml_m3_fit_to_4_sample10.rds"))
...
saveRDS(m3_fit_to_6, here("simulations","sim_mods","m3_fit_to_6_sample10.rds"))

# m3_fit_to_6 <- readRDS(here("simulations","sim_mods","m3_fit_to_6_sample10.rds"))
...
dummy_fit@sim <- m3_fit_to_6@sim
dummy_fit@inits <- m3_fit_to_6@inits
dummy_fit@mode <- m3_fit_to_6@mode
...
ml_m3_fit_to_6 <- bridge_sampler(
  samples = dummy_fit,
  data = datalist,
  silent = TRUE
)
saveRDS(ml_m3_fit_to_6, here("simulations","sim_mods","ml_m3_fit_to_6_sample10.rds"))

# ml_m3_fit_to_6 <- readRDS(here("simulations","sim_mods","ml_m3_fit_to_6_sample10.rds"))
...
saveRDS(m3_fit_to_bym, here("simulations","sim_mods","m3_fit_to_bym_sample10.rds"))

# m3_fit_to_bym <- readRDS(here("simulations","sim_mods","m3_fit_to_bym_sample10.rds"))

```


```{r}
summary(m3_fit_to_bym)

```

```{r}
ml_m3_fit_to_bym <- bridge_sampler(m3_fit_to_bym)
saveRDS(ml_m3_fit_to_bym, here("simulations","sim_mods","ml_m3_fit_to_bym_sample10.rds"))

# ml_m3_fit_to_bym <- readRDS(here("simulations","sim_mods","ml_m3_fit_to_bym_sample10.rds"))
...
```{r}
ml_mod3simulations <- data.frame(
  model = c("3",
            # "4",
            "6",
            "BYM2"),
  logmarglik = c(ml_m3_fit_to_3$logml, 
                 # ml_m3_fit_to_4$logml, 
                 ml_m3_fit_to_6$logml, 
                 ml_m3_fit_to_bym$logml)
) |> 
  arrange(desc(logmarglik))
ml_mod3simulations

saveRDS(ml_mod3simulations, here("simulations","sim_ml","ml_mod3simulations_sample10.rds"))
