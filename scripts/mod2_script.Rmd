...
```{r}
mod2_ld <- brm(ld24 ~ first_party19 + second_party19comp * majority_prop_scale +
...
saveRDS(mod2_ld, here("models5","mod2_ld.rds"))

mod2_ld <- readRDS(here("models5","mod2_ld.rds"))

summary_mod2_ld <- rbind(summary(mod2_ld)$fixed,
                           summary(mod2_ld)$random$region_name) |> 
  data.frame() |> 
  rownames_to_column("par")

margloglik_mod2_ld <- bridge_sampler(mod2_ld)
saveRDS(margloglik_mod2_ld, here("models5","margloglik_mod2_ld.rds"))

# margloglik_mod2_ld <- readRDS(here("models5","margloglik_mod2_ld.rds"))
...
```{r}
mod2_con <- brm(con24 ~ first_party19 + second_party19comp * majority_prop_scale +
                  degree_scale + notgoodhealth_scale + white_scale + (1 | region_name) +
                  offset(log(valid_votes24)),
                data=dfnbcon,
                family = poisson(),      # named list of data
                ...
                save_pars = save_pars(all = TRUE))
saveRDS(mod2_con, here("models5","mod2_con.rds"))

mod2_con <- readRDS(here("models5","mod2_con.rds"))

summary_mod2_con <- rbind(summary(mod2_con)$fixed,
                           summary(mod2_con)$random$region_name) |> 
  data.frame() |> 
  rownames_to_column("par")

margloglik_mod2_con <- bridge_sampler(mod2_con)
saveRDS(margloglik_mod2_con, here("models5","margloglik_mod2_con.rds"))

# margloglik_mod2_con <- readRDS(here("models5","margloglik_mod2_con.rds"))
...
```{r}
mod2_lab <- brm(lab24 ~ first_party19 + second_party19comp * majority_prop_scale +
                  degree_scale + notgoodhealth_scale + white_scale + (1 | region_name) +
                  offset(log(valid_votes24)),
                data=dfnblab,
                family = poisson(),      # named list of data
                ...
                save_pars = save_pars(all = TRUE))
saveRDS(mod2_lab, here("models5","mod2_lab.rds"))

mod2_lab <- readRDS(here("models5","mod2_lab.rds"))

summary_mod2_lab <- rbind(summary(mod2_lab)$fixed,
                           summary(mod2_lab)$random$region_name) |> 
  data.frame() |> 
  rownames_to_column("par")

margloglik_mod2_lab <- bridge_sampler(mod2_lab)
saveRDS(margloglik_mod2_lab, here("models5","margloglik_mod2_lab.rds"))

# margloglik_mod2_lab <- readRDS(here("models5","margloglik_mod2_lab.rds"))
...
```{r}
mod2_ruk <- brm(ruk24 ~ first_party19 + second_party19comp * majority_prop_scale +
                  degree_scale + notgoodhealth_scale + white_scale + (1 | region_name) +
                  offset(log(valid_votes24)),
                data=dfnbruk,
                family = poisson(),      # named list of data
                ...
                save_pars = save_pars(all = TRUE))
saveRDS(mod2_ruk, here("models5","mod2_ruk.rds"))

mod2_ruk <- readRDS(here("models5","mod2_ruk.rds"))

summary_mod2_ruk <- rbind(summary(mod2_ruk)$fixed,
                           summary(mod2_ruk)$random$region_name) |> 
  data.frame() |> 
  rownames_to_column("par")

margloglik_mod2_ruk <- bridge_sampler(mod2_ruk)
saveRDS(margloglik_mod2_ruk, here("models5","margloglik_mod2_ruk.rds"))

# margloglik_mod2_ruk <- readRDS(here("models5","margloglik_mod2_ruk.rds"))
