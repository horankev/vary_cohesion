...
mod4_ld <- brm(ld24 ~ first_party19 + second_party19comp * majority_prop_scale +
                 degree_scale + notgoodhealth_scale + white_scale +
                 car(W, gr=constituency_name, type = "bym2") +
               ...
               save_warmup = FALSE)
saveRDS(mod4_ld, here("models","mod4_ld.rds"))

# mod4_ld <- readRDS(here("models","mod4_ld.rds"))

# maxrhat <- brms::rhat(mod4_ld) %>% max()

```


```{r}
margloglik_mod4_ld <- bridge_sampler(mod4_ld)
saveRDS(margloglik_mod4_ld, here("margloglik","margloglik_mod4_ld.rds"))

# margloglik_mod4_ld <- readRDS(here("margloglik","margloglik_mod4_ld.rds"))
...
mod4_con <- brm(con24 ~ first_party19 + second_party19comp * majority_prop_scale +
                  degree_scale + notgoodhealth_scale + white_scale +
                  car(W, gr=constituency_name, type = "bym2") +
                  offset(log(valid_votes24)),
                data=dfnbcon,
                ...
                save_warmup = FALSE)
saveRDS(mod4_con, here("models","mod4_con.rds"))

# mod4_con <- readRDS(here("models","mod4_con.rds"))

# summary_mod4_con <- rbind(summary(mod4_con)$fixed,
#                            summary(mod4_con)$random$region_name) |>
#   data.frame() |>
#   rownames_to_column("par")

margloglik_mod4_con <- bridge_sampler(mod4_con)
saveRDS(margloglik_mod4_con, here("margloglik","margloglik_mod4_con.rds"))

# margloglik_mod4_con <- readRDS(here("margloglik","margloglik_mod4_con.rds"))

# maxrhat <- brms::rhat(mod4_con) %>% max()
...
mod4_lab <- brm(lab24 ~ first_party19 + second_party19comp * majority_prop_scale +
                  degree_scale + notgoodhealth_scale + white_scale +
                  car(W, gr=constituency_name, type = "bym2") +
                  offset(log(valid_votes24)),
                data=dfnblab,
                ...
                save_warmup = FALSE)
saveRDS(mod4_lab, here("models","mod4_lab.rds"))

# mod4_lab <- readRDS(here("models","mod4_lab.rds"))

# summary_mod4_lab <- rbind(summary(mod4_lab)$fixed,
#                            summary(mod4_lab)$random$region_name) |>
#   data.frame() |>
#   rownames_to_column("par")

margloglik_mod4_lab <- bridge_sampler(mod4_lab)
saveRDS(margloglik_mod4_lab, here("margloglik","margloglik_mod4_lab.rds"))

# margloglik_mod4_lab <- readRDS(here("margloglik","margloglik_mod4_lab.rds"))

# maxrhat <- brms::rhat(mod4_lab) %>% max()
...
mod4_ruk <- brm(ruk24 ~ first_party19 + second_party19comp * majority_prop_scale +
                  degree_scale + notgoodhealth_scale + white_scale +
                  car(W, gr=constituency_name, type = "bym2") +
                  offset(log(valid_votes24)),
                data=dfnbruk,
                ...
                save_warmup = FALSE)
saveRDS(mod4_ruk, here("models","mod4_ruk.rds"))

# mod4_ruk <- readRDS(here("models","mod4_ruk.rds"))

# summary_mod4_ruk <- rbind(summary(mod4_ruk)$fixed,
#                            summary(mod4_ruk)$random$region_name) |> 
#   data.frame() |> 
#   rownames_to_column("par")
# 
margloglik_mod4_ruk <- bridge_sampler(mod4_ruk)
saveRDS(margloglik_mod4_ruk, here("margloglik","margloglik_mod4_ruk.rds"))

# margloglik_mod4_ruk <- readRDS(here("margloglik","margloglik_mod4_ruk.rds"))

# maxrhat <- brms::rhat(mod4_ruk) %>% max()
