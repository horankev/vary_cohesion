...
```{r}
# will use cmdstan as backend as rstan was crashing for the following model due to size
# to do this, i run the following commands just once
# then set cmdstan as the backend in the brms model
...
# mod3_ld <- brm(ld24 ~ first_party19 + second_party19comp * majority_prop_scale +
...
#                save_warmup = FALSE)
# 
# saveRDS(mod3_ld, here("mods24","mods_ld","mod3_ld.rds"))

mod3_ld <- readRDS(here("mods24","mods_ld","mod3_ld.rds"))

# maxrhat <- brms::rhat(mod3_ld) %>% max()

```


```{r}
# summary_mod3_ld <- rbind(summary(mod3_ld)$fixed,
#                            summary(mod3_ld)$random$region_name) |> 
#   data.frame() |> 
#   rownames_to_column("par")

# margloglik_mod3_ld <- bridge_sampler(mod3_ld)
# saveRDS(margloglik_mod3_ld, here("mods24","mods_ld","margloglik_mod3_ld.rds"))

margloglik_mod3_ld <- readRDS(here("mods24","mods_ld","margloglik_mod3_ld.rds"))
...
# mod3_con <- brm(con24 ~ first_party19 + second_party19comp * majority_prop_scale +
#                   degree_scale + notgoodhealth_scale + white_scale +
#                   car(W, gr=constituency_name, type = "icar") +
#                   offset(log(valid_votes24)),
#                 data=dfnbcon,
...
#                 save_warmup = FALSE)
# 
# saveRDS(mod3_con, here("mods24","mods_con","mod3_con.rds"))

mod3_con <- readRDS(here("mods24","mods_con","mod3_con.rds"))

# summary_mod3_con <- rbind(summary(mod3_con)$fixed,
#                            summary(mod3_con)$random$region_name) |>
#   data.frame() |>
#   rownames_to_column("par")

# margloglik_mod3_con <- bridge_sampler(mod3_con)
# saveRDS(margloglik_mod3_con, here("mods24","mods_con","margloglik_mod3_con.rds"))

margloglik_mod3_con <- readRDS(here("mods24","mods_con","margloglik_mod3_con.rds"))

# maxrhat <- brms::rhat(mod3_con) %>% max()
...
# mod3_lab <- brm(lab24 ~ first_party19 + second_party19comp * majority_prop_scale +
#                   degree_scale + notgoodhealth_scale + white_scale +
#                   car(W, gr=constituency_name, type = "icar") +
#                   offset(log(valid_votes24)),
#                 data=dfnblab,
...
#                 save_warmup = FALSE)
# 
# saveRDS(mod3_lab, here("mods24","mods_lab","mod3_lab.rds"))

mod3_lab <- readRDS(here("mods24","mods_lab","mod3_lab.rds"))

# summary_mod3_lab <- rbind(summary(mod3_lab)$fixed,
#                            summary(mod3_lab)$random$region_name) |>
#   data.frame() |>
#   rownames_to_column("par")

# margloglik_mod3_lab <- bridge_sampler(mod3_lab)
# saveRDS(margloglik_mod3_lab, here("mods24","mods_lab","margloglik_mod3_lab.rds"))

margloglik_mod3_lab <- readRDS(here("mods24","mods_lab","margloglik_mod3_lab.rds"))

# maxrhat <- brms::rhat(mod3_lab) %>% max()
...
# mod3_ruk <- brm(ruk24 ~ first_party19 + second_party19comp * majority_prop_scale +
#                   degree_scale + notgoodhealth_scale + white_scale +
#                   car(W, gr=constituency_name, type = "icar") +
#                   offset(log(valid_votes24)),
#                 data=dfnbruk,
...
#                 save_warmup = FALSE)
# 
# saveRDS(mod3_ruk, here("mods24","mods_ruk","mod3_ruk.rds"))

mod3_ruk <- readRDS(here("mods24","mods_ruk","mod3_ruk.rds"))

# summary_mod3_ruk <- rbind(summary(mod3_ruk)$fixed,
#                            summary(mod3_ruk)$random$region_name) |> 
#   data.frame() |> 
#   rownames_to_column("par")
# 
# margloglik_mod3_ruk <- bridge_sampler(mod3_ruk)
# saveRDS(margloglik_mod3_ruk, here("mods24","mods_ruk","margloglik_mod3_ruk.rds"))

margloglik_mod3_ruk <- readRDS(here("mods24","mods_ruk","margloglik_mod3_ruk.rds"))

# maxrhat <- brms::rhat(mod3_ruk) %>% max()
