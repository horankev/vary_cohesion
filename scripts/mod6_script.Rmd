...
mod6_ld <- brm(ld24 ~ first_party19 + second_party19comp * majority_prop_scale +
                     degree_scale + notgoodhealth_scale + white_scale + (1 | region_name) +
                     car(W, gr=constituency_name, type = "icar") +
                     offset(log(valid_votes24)),
                   data=dfnbld,
                   data2 = list(W = W),
                   family = poisson(),      # named list of data
...
saveRDS(mod6_ld, here("models5","mod6_ld.rds"))

# mod6_ld <- readRDS(here("models5","mod6_ld.rds"))

summary_mod6_ld <- rbind(summary(mod6_ld)$fixed,
                           summary(mod6_ld)$random$region_name) |> 
  data.frame() |> 
  rownames_to_column("par")

margloglik_mod6_ld <- bridge_sampler(mod6_ld)
saveRDS(margloglik_mod6_ld, here("models5","margloglik_mod6_ld.rds"))

# margloglik_mod6_ld <- readRDS(here("models5","margloglik_mod6_ld.rds"))
...
mod6_con <- brm(con24 ~ first_party19 + second_party19comp * majority_prop_scale +
                      degree_scale + notgoodhealth_scale + white_scale + (1 | region_name) +
                      car(W, gr=constituency_name, type = "icar") +
                      offset(log(valid_votes24)),
                    data=dfnbcon,
                    ...
                    control = list(adapt_delta = 0.99,
                                   max_treedepth = 12),
                    save_pars = save_pars(all = TRUE))
saveRDS(mod6_con, here("models5","mod6_con.rds"))

# mod6_con <- readRDS(here("models5","mod6_con.rds"))

summary_mod6_con <- rbind(summary(mod6_con)$fixed,
                           summary(mod6_con)$random$region_name) |> 
  data.frame() |> 
  rownames_to_column("par")

margloglik_mod6_con <- bridge_sampler(mod6_con)
saveRDS(margloglik_mod6_con, here("models5","margloglik_mod6_con.rds"))

# margloglik_mod6_con <- readRDS(here("models5","margloglik_mod6_con.rds"))
...
mod6_lab <- brm(lab24 ~ first_party19 + second_party19comp * majority_prop_scale +
                      degree_scale + notgoodhealth_scale + white_scale + (1 | region_name) +
                      car(W, gr=constituency_name, type = "icar") +
                      offset(log(valid_votes24)),
                    data=dfnblab,
                    ...
                    control = list(adapt_delta = 0.99,
                                   max_treedepth = 12),
                    save_pars = save_pars(all = TRUE))
saveRDS(mod6_lab, here("models5","mod6_lab.rds"))

# mod6_lab <- readRDS(here("models5","mod6_lab.rds"))

summary_mod6_lab <- rbind(summary(mod6_lab)$fixed,
                           summary(mod6_lab)$random$region_name) |> 
  data.frame() |> 
  rownames_to_column("par")

margloglik_mod6_lab <- bridge_sampler(mod6_lab)
saveRDS(margloglik_mod6_lab, here("models5","margloglik_mod6_lab.rds"))

# margloglik_mod6_lab <- readRDS(here("models5","margloglik_mod6_lab.rds"))
...
mod6_ruk <- brm(ruk24 ~ first_party19 + second_party19comp * majority_prop_scale +
                      degree_scale + notgoodhealth_scale + white_scale + (1 | region_name) +
                      car(W, gr=constituency_name, type = "icar") +
                      offset(log(valid_votes24)),
                    data=dfnbruk,
                    ...
                    save_pars = save_pars(all = TRUE))
saveRDS(mod6_ruk, here("models5","mod6_ruk.rds"))

# mod6_ruk <- readRDS(here("models5","mod6_ruk.rds"))

summary_mod6_ruk <- rbind(summary(mod6_ruk)$fixed,
                           summary(mod6_ruk)$random$region_name) |> 
  data.frame() |> 
  rownames_to_column("par")

margloglik_mod6_ruk <- bridge_sampler(mod6_ruk)
saveRDS(margloglik_mod6_ruk, here("models5","margloglik_mod6_ruk.rds"))

# margloglik_mod6_ruk <- readRDS(here("models5","margloglik_mod6_ruk.rds"))
