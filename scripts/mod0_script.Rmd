...
```{r}
mod0_ld <- brm(ld24 ~ degree_scale + notgoodhealth_scale + white_scale +
...
saveRDS(mod0_ld, here("models5","mod0_ld.rds"))

# mod0_ld <- readRDS(here("models5","mod0_ld.rds"))

margloglik_mod0_ld <- bridge_sampler(mod0_ld)
saveRDS(margloglik_mod0_ld, here("models5","margloglik_mod0_ld.rds"))

# margloglik_mod0_ld <- readRDS(here("models5","margloglik_mod0_ld.rds"))
...
```{r}
mod0_con <- brm(con24 ~ degree_scale + notgoodhealth_scale + white_scale +
                  offset(log(valid_votes24)),
                data=dfnbcon,
                family = poisson(),      # named list of data
                chains = 4,             # number of Markov chains
                ...
                prior = priors,
                save_pars = save_pars(all = TRUE))
saveRDS(mod0_con, here("models5","mod0_con.rds"))

# mod0_con <- readRDS(here("models5","mod0_con.rds"))

margloglik_mod0_con <- bridge_sampler(mod0_con)
saveRDS(margloglik_mod0_con, here("models5","margloglik_mod0_con.rds"))

# margloglik_mod0_con <- readRDS(here("models5","margloglik_mod0_con.rds"))
...
```{r}
mod0_lab <- brm(lab24 ~ degree_scale + notgoodhealth_scale + white_scale +
                  offset(log(valid_votes24)),
                data=dfnblab,
                family = poisson(),      # named list of data
                chains = 4,             # number of Markov chains
                ...
                prior = priors,
                save_pars = save_pars(all = TRUE))
saveRDS(mod0_lab, here("models5","mod0_lab.rds"))

# mod0_lab <- readRDS(here("models5","mod0_lab.rds"))

margloglik_mod0_lab <- bridge_sampler(mod0_lab)
saveRDS(margloglik_mod0_lab, here("models5","margloglik_mod0_lab.rds"))

# margloglik_mod0_lab <- readRDS(here("models5","margloglik_mod0_lab.rds"))
...
```{r}
mod0_ruk <- brm(ruk24 ~ degree_scale + notgoodhealth_scale + white_scale +
                  offset(log(valid_votes24)),
                data=dfnbruk,
                family = poisson(),      # named list of data
                chains = 4,             # number of Markov chains
                ...
                prior = priors,
                save_pars = save_pars(all = TRUE))
saveRDS(mod0_ruk, here("models5","mod0_ruk.rds"))

# mod0_ruk <- readRDS(here("models5","mod0_ruk.rds"))

margloglik_mod0_ruk <- bridge_sampler(mod0_ruk)
saveRDS(margloglik_mod0_ruk, here("models5","margloglik_mod0_ruk.rds"))

# margloglik_mod0_ruk <- readRDS(here("models5","margloglik_mod0_ruk.rds"))
