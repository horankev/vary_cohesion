...
```{stan, output.var = "compiled_model_sim"}
data {
  ...
  vector<lower=0>[Nloc] sdcar;    // region-specific SDs for spatial term
...
transformed parameters {
  vector[N] rcar;
  for (n in 1:N) {
    rcar[n] = zcar[n] * sdcar[Jloc[n]];  // scale by region-specific SD
  }
}
...
generated quantities {
  ...
  for (n in 1:N) {
    ...
    real mu = Intercept + beta * X_sim[n] + rcar[n];
...
# saveRDS(sim_data_rcar, here("simulations2_wider_sd","sim_geo_data_sd1.3","sim_data_rcar_mod7_sd1.3.rds"))
...
saveRDS(m6_fit_to_3_sdcar_plus1, here("simulations2_wider_sd","sim_mods","m6_fit_to_3_sdcar_plus1.rds"))

# m6_fit_to_3_sdcar_plus1 <- readRDS(here("simulations2_wider_sd","sim_mods","m6_fit_to_3_sdcar_plus1.rds"))

```


```{r}
summary(m6_fit_to_3_sdcar_plus1)

```


```{r}
ml_m6_fit_to_3_sdcar_plus1 <- bridge_sampler(m6_fit_to_3_sdcar_plus1)
saveRDS(ml_m6_fit_to_3_sdcar_plus1, here("simulations2_wider_sd","sim_mods","ml_m6_fit_to_3_sdcar_plus1.rds"))

# ml_m6_fit_to_3_sdcar_plus1 <- readRDS(here("simulations2_wider_sd","sim_mods","ml_m6_fit_to_3_sdcar_plus1.rds"))
...
saveRDS(m6_fit_to_4_sdcar_plus1, here("simulations2_wider_sd","sim_mods","m6_fit_to_4_sdcar_plus1.rds"))

# m6_fit_to_4_sdcar_plus1 <- readRDS(here("simulations2_wider_sd","sim_mods","m6_fit_to_4_sdcar_plus1.rds"))

```


```{r}
summary(m6_fit_to_4_sdcar_plus1)

```

```{r}
ml_m6_fit_to_4_sdcar_plus1 <- bridge_sampler(m6_fit_to_4_sdcar_plus1)
saveRDS(ml_m6_fit_to_4_sdcar_plus1, here("simulations2_wider_sd","sim_mods","ml_m6_fit_to_4_sdcar_plus1.rds"))

# ml_m6_fit_to_4_sdcar_plus1 <- readRDS(here("simulations2_wider_sd","sim_mods","ml_m6_fit_to_4_sdcar_plus1.rds"))
...
```{r}
m6_fit_to_6_sdcar_plus1 <- rstan::sampling(
...
saveRDS(m6_fit_to_6_sdcar_plus1, here("simulations2_wider_sd","sim_mods","m6_fit_to_6_sdcar_plus1.rds"))

# m6_fit_to_6_sdcar_plus1 <- readRDS(here("simulations2_wider_sd","sim_mods","m6_fit_to_6_sdcar_plus1.rds"))

```


```{r}
summary(m6_fit_to_6_sdcar_plus1) |> 
  data.frame() |> 
  head()
...
dummy_fit@sim <- m6_fit_to_6_sdcar_plus1@sim
dummy_fit@inits <- m6_fit_to_6_sdcar_plus1@inits
dummy_fit@mode <- m6_fit_to_6_sdcar_plus1@mode
...
ml_m6_fit_to_6_sdcar_plus1 <- bridge_sampler(
  samples = dummy_fit,
  data = datalist,
  silent = TRUE
)
saveRDS(ml_m6_fit_to_6_sdcar_plus1, here("simulations2_wider_sd","sim_mods","ml_m6_fit_to_6_sdcar_plus1.rds"))

# ml_m6_fit_to_6_sdcar_plus1 <- readRDS(here("simulations2_wider_sd","sim_mods","ml_m6_fit_to_6_sdcar_plus1.rds"))
...
saveRDS(m6_fit_to_bym_sdcar_plus1, here("simulations2_wider_sd","sim_mods","m6_fit_to_bym_sdcar_plus1.rds"))

# m6_fit_to_bym_sdcar_plus1 <- readRDS(here("simulations2_wider_sd","sim_mods","m6_fit_to_bym_sdcar_plus1.rds"))

```


```{r}
summary(m6_fit_to_bym_sdcar_plus1)

```

```{r}
ml_m6_fit_to_bym_sdcar_plus1 <- bridge_sampler(m6_fit_to_bym_sdcar_plus1)
saveRDS(ml_m6_fit_to_bym_sdcar_plus1, here("simulations2_wider_sd","sim_mods","ml_m6_fit_to_bym_sdcar_plus1.rds"))

# ml_m6_fit_to_bym_sdcar_plus1 <- readRDS(here("simulations2_wider_sd","sim_mods","ml_m6_fit_to_bym_sdcar_plus1.rds"))
...
```{r}
ml_mod7simulations2_sdcar_plus1 <- data.frame(
  model = c("3","4","6","BYM2"),
  logmarglik = c(ml_m6_fit_to_3_sdcar_plus1$logml, ml_m6_fit_to_4_sdcar_plus1$logml, ml_m6_fit_to_6_sdcar_plus1$logml, ml_m6_fit_to_bym_sdcar_plus1$logml)
) |> 
  arrange(desc(logmarglik))
ml_mod7simulations2_sdcar_plus1

saveRDS(ml_mod7simulations2_sdcar_plus1, here("simulations2_wider_sd","sim_ml","ml_mod7simulations2_sdcar_plus1.rds"))
