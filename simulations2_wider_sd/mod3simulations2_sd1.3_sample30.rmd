...
```{r}
# use packages preferentially from my user library, not the system library
.libPaths(c("/home/researchers/khoran/R/x86_64-pc-linux-gnu-library/4.4", .libPaths()))
...
# 
# saveRDS(dfsmall, here("simulations2","dfsmall.rds"))

dfsmall <- readRDS(here("simulations2","dfsmall.rds"))
regions <- dfsmall |>
...
```{stan, output.var = "compiled_model3_sim"}
data {
...
saveRDS(m3_fit_to_3_sd1.3, here("simulations2","sim_mods","m3_fit_to_3_sd1.3_sample30.rds"))

# m3_fit_to_3_sd1.3 <- readRDS(here("simulations2","sim_mods","m3_fit_to_3_sd1.3_sample30.rds"))

```


```{r}
summary(m3_fit_to_3_sd1.3)

```


```{r}
ml_m3_fit_to_3_sd1.3 <- bridge_sampler(m3_fit_to_3_sd1.3)
saveRDS(ml_m3_fit_to_3_sd1.3, here("simulations2","sim_mods","ml_m3_fit_to_3_sd1.3_sample30.rds"))

# ml_m3_fit_to_3_sd1.3 <- readRDS(here("simulations2","sim_mods","ml_m3_fit_to_3_sd1.3_sample30.rds"))
...
saveRDS(m3_fit_to_4_sd1.3, here("simulations2","sim_mods","m3_fit_to_4_sd1.3_sample30.rds"))

# m3_fit_to_4_sd1.3 <- readRDS(here("simulations2","sim_mods","m3_fit_to_4_sd1.3_sample30.rds"))

```


```{r}
summary(m3_fit_to_4_sd1.3)

```

```{r}
ml_m3_fit_to_4_sd1.3 <- bridge_sampler(m3_fit_to_4_sd1.3)
saveRDS(ml_m3_fit_to_4_sd1.3, here("simulations2","sim_mods","ml_m3_fit_to_4_sd1.3_sample30.rds"))

# ml_m3_fit_to_4_sd1.3 <- readRDS(here("simulations2","sim_mods","ml_m3_fit_to_4_sd1.3_sample30.rds"))
...
```{r}
m3_fit_to_6_sd1.3 <- rstan::sampling(
...
saveRDS(m3_fit_to_6_sd1.3, here("simulations2","sim_mods","m3_fit_to_6_sd1.3_sample30.rds"))

# m3_fit_to_6_sd1.3 <- readRDS(here("simulations2","sim_mods","m3_fit_to_6_sd1.3_sample30.rds"))

```


```{r}
summary(m3_fit_to_6_sd1.3)
...
dummy_fit@sim <- m3_fit_to_6_sd1.3@sim
dummy_fit@inits <- m3_fit_to_6_sd1.3@inits
dummy_fit@mode <- m3_fit_to_6_sd1.3@mode
...
ml_m3_fit_to_6_sd1.3 <- bridge_sampler(
  samples = dummy_fit,
  data = datalist,
  silent = TRUE
)
saveRDS(ml_m3_fit_to_6_sd1.3, here("simulations2","sim_mods","ml_m3_fit_to_6_sd1.3_sample30.rds"))

# ml_m3_fit_to_6_sd1.3 <- readRDS(here("simulations2","sim_mods","ml_m3_fit_to_6_sd1.3_sample30.rds"))
...
#   save_pars = save_pars(all = TRUE)
# )
# saveRDS(m3_fit_to_bym_sd1.3, here("simulations2","sim_mods","m3_fit_to_bym_sd1.3_sample30.rds"))

# m3_fit_to_bym_sd1.3 <- readRDS(here("simulations2","sim_mods","m3_fit_to_bym_sd1.3_sample30.rds"))

```


```{r}
# summary(m3_fit_to_bym_sd1.3)

```

```{r}
# ml_m3_fit_to_bym_sd1.3 <- bridge_sampler(m3_fit_to_bym_sd1.3)
# saveRDS(ml_m3_fit_to_bym_sd1.3, here("simulations2","sim_mods","ml_m3_fit_to_bym_sd1.3_sample30.rds"))

# ml_m3_fit_to_bym_sd1.3 <- readRDS(here("simulations2","sim_mods","ml_m3_fit_to_bym_sd1.3_sample30.rds"))
...
```{r}
ml_mod3simulations2_sd1.3 <- data.frame(
  model = c("3","4","6"
            # "BYM2"
            ),
  logmarglik = c(ml_m3_fit_to_3_sd1.3$logml, 
                 ml_m3_fit_to_4_sd1.3$logml, 
                 ml_m3_fit_to_6_sd1.3$logml 
                 # ml_m3_fit_to_bym_sd1.3$logml
                 )
) |> 
  arrange(desc(logmarglik))
ml_mod3simulations2_sd1.3

saveRDS(ml_mod3simulations2_sd1.3, here("simulations2","sim_ml","ml_mod3simulations2_sd1.3_sample30.rds"))
