...
saveRDS(m3_fit_to_3_sd1.3, here("simulations2_wider_sd","sim_mods","m3_fit_to_3_sd1.3.rds"))

# m3_fit_to_3_sd1.3 <- readRDS(here("simulations2_wider_sd","sim_mods","m3_fit_to_3_sd1.3.rds"))
...
saveRDS(ml_m3_fit_to_3_sd1.3, here("simulations2_wider_sd","sim_mods","ml_m3_fit_to_3_sd1.3.rds"))

# ml_m3_fit_to_3_sd1.3 <- readRDS(here("simulations2_wider_sd","sim_mods","ml_m3_fit_to_3_sd1.3.rds"))
...
saveRDS(m3_fit_to_4_sd1.3, here("simulations2_wider_sd","sim_mods","m3_fit_to_4_sd1.3.rds"))

# m3_fit_to_4_sd1.3 <- readRDS(here("simulations2_wider_sd","sim_mods","m3_fit_to_4_sd1.3.rds"))
...
saveRDS(ml_m3_fit_to_4_sd1.3, here("simulations2_wider_sd","sim_mods","ml_m3_fit_to_4_sd1.3.rds"))

# ml_m3_fit_to_4_sd1.3 <- readRDS(here("simulations2_wider_sd","sim_mods","ml_m3_fit_to_4_sd1.3.rds"))
...
saveRDS(m3_fit_to_6_sd1.3, here("simulations2_wider_sd","sim_mods","m3_fit_to_6_sd1.3.rds"))

# m3_fit_to_6_sd1.3 <- readRDS(here("simulations2_wider_sd","sim_mods","m3_fit_to_6_sd1.3.rds"))
...
saveRDS(ml_m3_fit_to_6_sd1.3, here("simulations2_wider_sd","sim_mods","ml_m3_fit_to_6_sd1.3.rds"))

# ml_m3_fit_to_6_sd1.3 <- readRDS(here("simulations2_wider_sd","sim_mods","ml_m3_fit_to_6_sd1.3.rds"))
...
saveRDS(m3_fit_to_bym_sd1.3, here("simulations2_wider_sd","sim_mods","m3_fit_to_bym_sd1.3.rds"))

# m3_fit_to_bym_sd1.3 <- readRDS(here("simulations2_wider_sd","sim_mods","m3_fit_to_bym_sd1.3.rds"))
...
saveRDS(ml_m3_fit_to_bym_sd1.3, here("simulations2_wider_sd","sim_mods","ml_m3_fit_to_bym_sd1.3.rds"))

# ml_m3_fit_to_bym_sd1.3 <- readRDS(here("simulations2_wider_sd","sim_mods","ml_m3_fit_to_bym_sd1.3.rds"))
...
ml_mod3simulations2_sd1.3 <- data.frame(
  model = c("3","4","6","BYM2"),
  logmarglik = c(ml_m3_fit_to_3_sd1.3$logml, ml_m3_fit_to_4_sd1.3$logml, ml_m3_fit_to_6_sd1.3$logml, ml_m3_fit_to_bym_sd1.3$logml)
) |> 
  arrange(desc(logmarglik))
ml_mod3simulations2_sd1.3

saveRDS(ml_mod3simulations2_sd1.3, here("simulations2_wider_sd","sim_ml","ml_mod3simulations2_sd1.3.rds"))
